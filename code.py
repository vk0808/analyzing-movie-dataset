...
def explore_data(dataset, start, end, rows_and_columns=False):
    ...
    if rows_and_columns:
        print('Number of rows: {}'.format(len(dataset)), 'Number of columns: {}'.format(len(dataset[0])), sep='\n')
...
def duplicate_and_unique_movies(dataset, index_):
    ...
    print('Number of duplicate movies: {}'.format(len(duplicate)))
    print('Examples of duplicate movies:', duplicate[:10])
...
def rate_bucket(dataset, rate_low, rate_high):
    ...
    print("Examples of movies in required rating:")    
